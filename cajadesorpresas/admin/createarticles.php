<?php 
	...
	if(isset($_POST['title'], $_POST['body'], $_POST['date'], $_POST['author'])):
    	...
    	$realfate = "img/".$img;
    	copy($path, $fate);
		AddArticle($enlace, $title, $body, $date, $author, $realfate);
		$enviado = true;
	endif
 ?>
		...
		<?php 
			if($enviado):?>
				<div class="alert alert-success" role="alert">
  					<a href="panel.php" class="alert-link"><strong>¡Enhorabuena!</strong> El articulo ha sido creado satisfactoriamente.</a>
				</div>
		<?php
			endif;
		 ?>		
			...
			<form method="post" class="col s12 m4 l8" enctype="multipart/form-data">
				...
				<div>
					<label for="textarea1">Cuerpo del post</label>
          			<textarea name="body" id="editor" cols="30" rows="15"></textarea>
					<br>
				</div>
				<div class="input-field">
					<i class="material-icons prefix">today</i>
					<input type="date" name="date" value="<?php echo date("Y-m-d");?>" class="validate" required>
					<br>	
				</div>
				...
				<div class="input-field">
					...
					<input type="text" name="author" value="<?php echo $_SESSION['user']; ?>" class="validate">
					<label for="autor">Autor</label>
				</div>
				<br><br>
				<div class="row">
					<div class="col s12 offset-s8">
						<button class="btn waves-effect waves-light" type="submit" name="action">CREAR ARTICULO
